...
mirror: analyses/subsystems/power.py
---

# analyses/subsystems/power.py
...
from craft.schema.subsystems.power import (
    BatteriesName,
    BatteryEntry,
    PDMsName,
    PDMEntry,
...
def test_total_power_by_mode():
    from craft.analyses.subsystems.power import total_power_by_mode
