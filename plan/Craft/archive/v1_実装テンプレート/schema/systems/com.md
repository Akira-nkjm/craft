...
mirror: schema/systems/com.py
---

# schema/systems/com.py
...
@component(system="com", base="power_spec", mixin="temperature")
class Transceiver:
    """通信機（送受信統合）。"""
...
@component(system="com", plural="sband_antennas")    # ← 自動複数形化が変な単語
class SbandAntenna:
    """S 帯アンテナ。"""
