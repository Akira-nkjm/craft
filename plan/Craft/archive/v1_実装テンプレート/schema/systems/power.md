...
mirror: schema/systems/power.py
---

# schema/systems/power.py
...
@component(system="power", mixin="temperature")
class Battery:
...
@component(system="power", has_power_mode=True)
class PDM:
...
### `@component(system=..., mixin=..., base=..., has_power_mode=..., plural=...)`

- `system=` — 必須。所属 system 名
