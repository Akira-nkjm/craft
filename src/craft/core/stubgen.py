...
from craft.core.paths import subsystem_dir
from craft.schema.codegen.stubgen import STUB_FILENAME, apply_ruff_format, render_subsystem_stub
from craft.schema.registry import UnifiedRegistry, default_registry
