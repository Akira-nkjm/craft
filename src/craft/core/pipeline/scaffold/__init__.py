...
from craft.core.io.toml_io import read_toml_doc, write_toml_atomic
from craft.core.paths import system_data_path
from craft.core.pipeline.scaffold.builders import (
    ScaffoldMode,
    scaffold_component,
    scaffold_config,
)
from craft.core.pipeline.scaffold.formatting import normalize_scaffold_spacing
