...
def runs_list(limit: int = typer.Option(20, "--limit", "-n", min=0, help="最大件数")) -> None:
    ...
    from craft.core.persistence.runs import list_runs, run_to_dict
...
def runs_show(run_id: str) -> None:
    ...
    from craft.core.persistence.runs import get_run, run_to_dict
...
def runs_latest() -> None:
    ...
    from craft.core.persistence.runs import get_run, latest_run_id, run_to_dict
...
def runs_artifact(run_id: str, name: str) -> None:
    ...
    from craft.core.persistence.runs import get_run_artifact
...
def analysis_list() -> None:
    """登録済み @analysis 関数を一覧。"""
    _bootstrap()
    from craft.core.surface_ops.introspection import list_analyses_summary
...
def analysis_run(
    ...
    from craft.core.analysis.runner import AnalysisArgumentError, AnalysisNotFound
    from craft.core.analysis.runner import run_analysis as _run_analysis
