...
def history_cmd(
    ...
    """git log 由来の変更履歴を表示。"""
    from craft.core.persistence.history import GitError, GitRefNotFound, git_log
...
def diff_cmd(
    ...
    """2 点間の git diff を表示。"""
    from craft.core.persistence.history import GitError, GitRefNotFound, git_diff
...
def gen_stubs_cmd(
    ...
    from craft.core.stubgen import check_stubs, generate_stubs
...
def init_subsystem(
    ...
    from craft.cli import templates
