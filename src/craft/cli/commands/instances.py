...
from craft.cli._etag import _resolve_instance_etag
from craft.cli._io import _format_validation_error, _load_payload, _print_json
...
def create_cmd(
    ...
    _bootstrap()
    from craft.cli.error_mapping import exit_if_error
    from craft.core.surface_ops.operations import create_component_op
...
def put_cmd(
    ...
    from craft.core.surface_ops.operations import replace_component_op
...
def patch_cmd(
    ...
    from craft.cli.error_mapping import exit_if_error
    from craft.core.surface_ops.concurrency import ETagMode, resolve_expected_etag
    from craft.core.surface_ops.operations import patch_component_op
...
def delete_cmd(
    ...
    from craft.cli.error_mapping import exit_if_error
    from craft.core.surface_ops.concurrency import ETagMode, resolve_expected_etag
    from craft.core.surface_ops.operations import delete_component_op
