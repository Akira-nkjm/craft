...
def _patch_create(exc: Exception):
    return patch("craft.core.surface_ops.operations.create_instance", side_effect=exc)


def _patch_delete(exc: Exception):
    return patch("craft.core.surface_ops.operations.delete_instance", side_effect=exc)


def _patch_patch(exc: Exception):
    return patch("craft.core.surface_ops.operations.patch_instance", side_effect=exc)
